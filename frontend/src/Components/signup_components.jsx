...
export class Signup extends Component {
    ...
    handleSubmit(e){
        ...
        .then((data) => {
            console.log(data, 'userReagistered ')
        })
    }
    ...
    return (
      <form onSubmit={this.handleSubmit}>
        ...
        <div className="mb-3">
            ...
            <input type="password" className='form-control' placeholder='Enter password' onChange={e=>this.setState({password66666:e.target.value})}/>
        </div>
        ...
        <p className="forget-passwordtext-right">
